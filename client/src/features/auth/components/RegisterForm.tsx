    ...
    <>
      ...
      <Form method="post" action="/auth/register" className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full pl-10 pr-3 py-3 border rounded-lg bg-white text-gray-700 placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus:border-green-600 ${
        ...
        <button
          ...
          className="w-full bg-green-600 hover:bg-green-700 disabled:bg-green-800 disabled:opacity-60 text-white font-semibold py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
        >
